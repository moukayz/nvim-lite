...
assert(opts.header == nil, "Worktree hints must be generated from actions")
assert(opts.actions["ctrl-t"].header == "Open tab")
assert(opts.actions.enter.header == "Open diff")
opts.actions["ctrl-t"].fn({ selected })
